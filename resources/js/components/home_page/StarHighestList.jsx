...
import { star, starHalf as starHalfIcon, starOutline as starOutlineIcon} from 'ionicons/icons'; // 避免衝突
...
const StarHighestCard = ({ starHighest }) => {
    ...
    const decideStar = (averating) => {
        ...
        const starHalf = <IonIcon icon={starHalfIcon} className="star-filled" />;
        const starOutline = <IonIcon icon={starOutlineIcon} className="star-outline" />;
