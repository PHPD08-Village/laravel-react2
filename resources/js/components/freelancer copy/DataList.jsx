...
const DataList = ({ item, timeDifference, className }) => {
    ...
    return (
        <div className={`fcontent ${className}`}>
            <div className="fcontent1" onClick={() => navigate("/detail", { state: { pid: item.pid, timeDifference: timeDifference.toString() } })}>
            ...
            <div className="fcontent2" onClick={() => navigate("/detail", { state: { pid: item.pid, timeDifference: timeDifference.toString() } })}>
